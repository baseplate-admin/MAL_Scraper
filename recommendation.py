...
for file in FILES:
    ...
    res = session.get(f"https://api.jikan.moe/v4/anime/{mal_id}/recommendations")
    json_data["data"]["recommendations"] = res.json().get("data")
    ...
    if json.load(
        ...
        print(f"Got Recommendation info for {mal_id}")
